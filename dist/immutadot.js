(function (global, factory) {
	...
	* @since 1.0.0
	...
	function get() {
	  ...
	  if (isString(firstArg)) return makeGetter.apply(undefined, args);
	  return makeGetter.apply(undefined, _toConsumableArray(argsRest))(firstArg);
	}

	function makeGetter(path, defaultValue) {
	  var getterFn = function getterFn(obj) {
	      ...
	      var walkPath = function walkPath(curObj, curPath, remPath) {
	        ...
	        if (remPath.length === 1) {
	          ...
	          var resolvedArgs = args.map(function (arg) {
	            return arg[getter] ? arg(obj) : arg;
	          });
	          operation.apply(undefined, [_newObj2, propValue, value].concat(_toConsumableArray(resolvedArgs)));
